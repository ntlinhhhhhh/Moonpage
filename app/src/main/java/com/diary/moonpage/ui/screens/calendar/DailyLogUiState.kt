...
data class DailyLogUiState(
    ...
    val isMusicSectionEnabled: Boolean = true,
    val isSleepSectionEnabled: Boolean = true,
    val isStepsSectionEnabled: Boolean = true,
    val isMenstruationSectionEnabled: Boolean = true,
    ...
    val collapsedActivityCategories: Set<String> = emptySet(),
